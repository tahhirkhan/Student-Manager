...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
	 ...
	 <h2 class="d-flex justify-content-center">ALL STUDENTS</h2>
	...
	<%
		...
		List<Student> list =(List<Student>) request.getAttribute("allStudents");
		for (Student listItem : list) {
	...
	%>
			...
			<tr>
				...
				<td><%= listItem.getBranch() %></td>
				<td><%= listItem.getGender() %></td>
